...
const AuthForm = ({ auth }) => {
    ...
    return (
        <Form noValidate validated={auth.validated} onSubmit={auth.mode === "login" ? auth.logInHandler : auth.signUpHandler} className='d-flex flex-column justify-content-center align-items-center w-75 gap-3'>
